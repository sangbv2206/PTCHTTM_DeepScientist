...
# =========================================================================
# BASELINE TEMPORAL FORECASTING ARCHITECTURE (GRU + Linear Projector)
# =========================================================================
class TemporalForecastingModel(nn.Module):
    """Mô hình dự báo chuỗi thời gian phụ tải điện năng."""
...
# =========================================================================
def main():
    parser = argparse.ArgumentParser(description="Household Energy Consumption Forecasting Benchmark")
    ...
    print(
        f"[EXPERIMENT COMPLETED] Test MSE: {final_info['best_test_mse']:.4f}, "
