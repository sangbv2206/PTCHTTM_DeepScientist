...
Đăng ký lấy Google Gemini API Key hoàn toàn miễn phí (0đ) tại [Google AI Studio](https://aistudio.google.com/).
...
| `--template` | `None` (Tự động chọn) | Mẫu thực nghiệm cơ sở (`gnn_graph_learning`, `recommender_system`,...) |
